    ...
    return (
        <div id='projects_block'>
            ...
            <div id='projects_grid'>
                ...
                <div>Find a path in a maze from a startpoint to endpoint with depth-first, breadth-first, and A* search algorithms.</div>
                ...
                <div>Javascript, HTML, CSS</div>
                <div>Place points and animate the creation of a convex hull or a minimum spanning tree with weights based on Euclidian distance.</div>
                ...
                <div>Java, JavaFX</div>
                <div>Simulate a pandemic spreading throughout a population. Physically divide areas by drawing walls.</div>
                ...
                <div>Personal portfolio website. See my projects, experience, and contacts.</div>
            </div>
        </div>
    )
}
